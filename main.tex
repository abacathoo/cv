...
\item[] \textbf{GCE} Electronics: \emph{A (full marks in 5 modules, one of the AS modules not taken)}\hfill \textbf{June 2008}
...
\begin{innerlist}
\item Installed the mesh boxes we had been working on all summer in a village and trained community volunteers to use the system and help others. Monitored load using my monitoring software.
...
\begin{innerlist}
\item Fluent: C, C$+$$+$, Java, JavaScript, PHP, ML, UNIX shell scripting, SQL
\item Good Knowledge: Perl, Haskell, Prolog, SystemVerilog, Python
\end{innerlist}
\textbf{Tools}
\begin{innerlist}
